    ...
    <main className="min-h-screen bg-neutral-950 text-white">
      ...
      <header className="sticky top-0 z-40 backdrop-blur supports-[backdrop-filter]:bg-neutral-950/70 bg-neutral-950/90 border-b border-white/10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          ...
          <a
            href="#apply"
            className="inline-flex items-center gap-2 rounded-2xl bg-white text-neutral-900 px-4 py-2 text-sm font-semibold hover:bg-white/90 a-link"
          >
            Apply now
          </a>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight tracking-tight">
                Become a job‑ready{" "}
                <span className="bg-clip-text text-transparent bg-gradient-to-br from-cyan-400 via-fuchsia-500 to-amber-400">
                  UX/UI Designer
                </span>{" "}
                in 12 weeks.
              </h1>
              <p className="mt-5 text-lg text-white/80 max-w-xl">
                Learn by building real products with mentors from top studios.
                Graduate with a standout portfolio, interview prep, and
                referrals.
              </p>
              <div className="mt-8 flex flex-col sm:flex-row gap-3">
                <a
                  onClick={() => navigateTo("apply")}
                  className="inline-flex justify-center items-center rounded-2xl bg-white text-neutral-900 px-6 py-3 font-semibold shadow-lg shadow-white/10 hover:bg-white/90 a-link"
                >
                  Start application
                </a>
                <a
                  onClick={() => navigateTo("apply")}
                  className="inline-flex justify-center items-center rounded-2xl border border-white/20 px-6 py-3 font-semibold hover:bg-white/10 a-link"
                >
                  Download syllabus
                </a>
              </div>
              <p className="mt-4 text-xs text-white/60">
                Cohort starts {eventDate.start} • Limited seats • No design
                background required
              </p>
            </div>
            <div className="relative">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-neutral-950/80 to-transparent">
                    <div className="flex justify-center flex-wrap gap-2">
                      {applicationTools.map(({ label, value }) => (
                        <span
                          key={value}
                          className="rounded-xl bg-white/5 px-3 py-1 text-xs border border-white/10"
                        >
                          {label}
                        </span>
                      ))}
              ...
              <div className="absolute -bottom-6 -right-6 hidden sm:block">
                <div className="rounded-2xl bg-white text-neutral-900 px-4 py-2 text-sm font-semibold shadow">
      ...
      <section id="outcomes" className="border-t border-white/10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="mt-8 grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                t: "Portfolio that gets interviews",
                d: "3 end‑to‑end case studies with research, flows, UI, testing, and impact metrics.",
              },
              {
                t: "Real‑world experience",
                d: "Client‑style briefs, deadlines, stakeholder reviews, and iteration cycles.",
              },
              {
                t: "Mentor feedback",
                d: "Weekly critique from senior designers and hiring managers.",
              },
              {
                t: "Placement support",
                d: "Resume/LinkedIn overhaul, mock interviews, referrals to partner companies.",
              },
              {
                t: "Figma mastery",
                d: "Design systems, components, auto‑layout, prototyping, variables.",
              },
              {
                t: "Confidence",
                d: "A clear story of your skills and a plan to keep growing post‑program.",
              },
            ].map(({ t, d }) => (
              <div
                key={t}
      ...
      <section id="projects" className="border-t border-white/10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
          <h2 className="text-3xl md:text-4xl font-bold">
            Show‑stopping portfolio projects
          </h2>
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            {[
              {
                t: "Fintech Mobile App",
                d: "Onboarding, money transfer, analytics, accessibility checks.",
                img: fintechImg,
              },
              {
                t: "Healthcare Web App",
                d: "Appointments, records, HIPAA‑aware flows, empty‑state strategy.",
                img: healthcareImg,
              },
              {
                t: "E‑commerce Revamp",
                d: "Product discovery, filters, cart‑abandon strategies, conversions.",
                img: ecommerceImg,
              },
            ].map(({ t, d, img }) => (
              <div
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-start">
            <div>
              ...
              <p className="mt-3 text-white/80 max-w-prose">
                Pay once and save, or split into easy EMIs. Scholarships
                available for women returning to work and need‑based applicants.
              </p>

              <div className="mt-6 inline-flex rounded-xl border border-white/15 p-1 gap-2">
                <button
                  onClick={() => setPricePlan("full")}
                  className={`px-4 py-2 rounded-lg text-sm bg-white ${pricePlan === "full" ? "[color:#747bff]" : "text-neutral-900"}`}
                >
                  Full Pay
                </button>
                <button
                  onClick={() => setPricePlan("emi")}
                  className={`px-4 py-2 rounded-lg text-sm bg-white ${pricePlan === "emi" ? "[color:#747bff]" : "text-neutral-900"}`}
                >
                  EMI
                </button>
              </div>
              ...
              <div className="mt-4 grid sm:grid-cols-2 gap-4">
                <div className="rounded-2xl border border-emerald-500/30 bg-emerald-500/10 p-4">
                  ...
                  <p className="text-xs text-white/70 mt-1">
                    Up to 30% off for eligible students. Limited.
                  </p>
                </div>
                <div className="rounded-2xl border border-cyan-500/30 bg-cyan-500/10 p-4">
                  ...
                  <p className="text-xs text-white/70 mt-1">
                    Split into 3 payments. Instant approval on most cards.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div
              id="apply"
              className="rounded-3xl border border-white/10 bg-neutral-900 p-6 lg:p-8"
            >
              <h3 className="text-2xl font-bold">
                Apply for the {eventDate.start} cohort
              </h3>
              <p className="text-white/70 mt-1 text-sm">
                {eventDate.duration} • {eventDate.weekdayBatch} •{" "}
                {eventDate.weekendBatch}
              </p>
              <form
              ...
              >
                ...
                <p className="text-xs text-white/60">
                  By submitting, you agree to our terms and consent to be
                  contacted via WhatsApp/Email.
                </p>
              </form>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid md:grid-cols-3 gap-6">
            {[
              {
                t: "Bonus: AI Toolkit",
                d: "Prompts, templates, and workflows to speed up research, ideation, and UI delivery.",
              },
              {
                t: "Bonus: Hiring Pack",
                d: "Resume, LinkedIn, and portfolio templates that recruiters love.",
              },
              {
                t: "7‑Day Satisfaction Guarantee",
                d: "If it’s not a fit within the first week, get a full refund. No questions asked.",
              },
            ].map(({ t, d }) => (
              <div
                key={t}
      ...
      <section className="border-t border-white/10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="mt-8 grid md:grid-cols-2 gap-6">
            {[
              {
                q: "I got 4 interviews in 2 weeks—my portfolio finally told a clear story.",
                n: "Aarthi R.",
                r: "UX Designer @ SaaS startup",
              },
              {
                q: "The mentor feedback was brutal in the best way. I learned how to think like a product designer.",
                n: "Pranav S.",
                r: "Product Designer @ Fintech",
              },
            ].map(({ q, n, r }) => (
              <div
                key={n}
            ...
            {[
              {
                ...
                a: "No. We start from fundamentals and ramp fast with hands‑on projects.",
              },
              {
                q: "Is it live or recorded?",
                a: "Live, with recordings available for revision.",
              },
              {
                q: "Will you help with placements?",
                a: "Yes—resume/LinkedIn, mock interviews, and referrals to hiring partners.",
              },
              {
                q: "What software do I need?",
                a: "Figma (free), Notion (free), optional Framer. We provide setup guides.",
              },
              {
                q: "Refund policy?",
              ...
              },
              {
                ...
                a: "Yes, on successful completion of capstones and reviews.",
              },
            ].map(({ q, a }) => (
              <div
                key={q}
      ...
      <section className="border-t border-white/10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 text-center">
          ...
          <p className="mt-3 text-white/80">
            Join the {eventDate.start} cohort and build a portfolio that opens
            doors.
          </p>
          <div className="mt-6 flex items-center justify-center gap-3">
            <a
              onClick={(e) => navigateTo("apply")}
              className="inline-flex justify-center items-center rounded-2xl bg-white text-neutral-900 px-6 py-3 font-semibold hover:bg-white/90 a-link"
            >
              Apply now
            </a>
            <a
      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 text-sm text-white/70">
          <div className="grid md:grid-cols-4 gap-6">
            <div>
              ...
              <p className="mt-3 text-white/60">
                Chennai • Bengaluru • Hyderabad (Online & Offline)
              </p>
            </div>
            <div>
          ...
          <p className="mt-8 text-xs text-white/50">
            © {new Date().getFullYear()} DesignX Skool. All rights reserved.
          </p>
        </div>
      </footer>
    </main>
